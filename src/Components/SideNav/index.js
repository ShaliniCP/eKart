...
import accordianSlice from '../../Redux/Accordion/accordianSlice';
import { useEffect, useState } from 'react';
import { getCategories } from '../../Redux/Category/actions';
import { filterByPrice, filterProducts } from '../../Redux/Products/productSlice';
const SideNav=()=>{

    const items=useSelector(state=>state.categoryReducer.categories);
        ...
        <div className="side-nav">
            ...
            </div>
            {
                items.map((section,key)=>{
                   if(section.parent_category_id===null){
                    return(
                        ...
                        <ul>
                            {
                                ...
                                items.map((subcategory)=>{
                                    if(section.id===subcategory.parent_category_id)
                                    return(
